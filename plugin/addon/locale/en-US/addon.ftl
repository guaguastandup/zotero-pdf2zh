...
operation-recovery-waiting = Translation request dropped. Waiting for the Server to finish, then attaching PDFs…
operation-recovery-done = Recovered { $count } attachment(s) automatically
